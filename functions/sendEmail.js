...
exports.handler = async function (event, context) {
    try {
        ...
        const { name, messages, numbers, emails, dates } = requestBody;

        console.log('Email details:', { name, messages, numbers, emails, dates });
...
Le nom : ${name} <br> Nombre de Passagers : ${numbers} <br>Email : ${emails} <br> la date : ${dates} <br> Message : ${messages} <br>
</p>
