...
exports.handler = async function (event, context) {
    try {
        ...
        const { name, messages, numbers, emails, dates, tel } = requestBody;

        console.log('Email details:', { name, messages, numbers, emails, dates, tel });
...
Le nom : ${name} <br> Nombre de Passagers : ${numbers} <br>Email : ${emails} <br> telephone : ${tel} <br> la date : ${dates} <br> Message : ${messages} <br>
</p>
